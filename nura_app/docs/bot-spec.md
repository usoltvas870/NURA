...
[Мини-разбор совместимости (2-3 бесплатных блока)]
    ↓
[CTA: купить полный разбор совместимости 390₽]
```
...
### 8.9. Flow — покупка полного разбора совместимости

Аналогично матрице, но:
- callback_data: `pay_compatibility:{token}`
- цена: 390₽
- в уведомлении: "Твой полный разбор совместимости готов!"

### 8.10. Webhook-обработчик (API)
...
| Возможность | Бесплатно | Полный отчёт | Подписка |
|---|---|---|---|
| Расчёт матрицы | ✅ | ✅ | ✅ |
| Мини-разбор (5 блоков) | ✅ | ✅ | ✅ |
| Полный AI-отчёт | ❌ | ✅ (1 шт) | ✅ (безлимит) |
