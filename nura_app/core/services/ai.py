...
SYSTEM_PROMPT = """Ты — NURA, AI-проводник в самопознании через Матрицу Судьбы.
...
CHAT_SYSTEM_PROMPT_TEMPLATE = """Ты — NURA, AI-проводник в Матрицу Судьбы. Ты в живом диалоге с пользователем.
