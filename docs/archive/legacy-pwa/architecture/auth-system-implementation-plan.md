...
>
> Сохранено как история PWA-first web-auth. Документ не управляет текущей Telegram-first разработкой. Актуальные источники: [product spec](../../../product/NURA_1_0_1_5_PRODUCT_SPEC.md), [current status](../../../implementation/current-status.md), [legacy index](../README.md).
