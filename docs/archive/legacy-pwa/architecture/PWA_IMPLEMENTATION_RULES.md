...
> **STATUS: LEGACY — COMPATIBILITY RULES**
>
> Retained for safe maintenance of the legacy PWA. It does not define current product scope. See [legacy index](../README.md) and [current status](../../../implementation/current-status.md).
