...
>
> Сохранено как PWA-first architecture/history. Документ не управляет текущей разработкой. См. [legacy index](../README.md), [product spec](../../../product/NURA_1_0_1_5_PRODUCT_SPEC.md), [current status](../../../implementation/current-status.md).
