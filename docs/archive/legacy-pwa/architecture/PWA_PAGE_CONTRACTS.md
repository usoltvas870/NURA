...
> **STATUS: LEGACY — COMPATIBILITY CONTRACT**
>
> Retained for supported legacy PWA pages. It does not define the current Telegram-first roadmap. See [legacy index](../README.md) and [current status](../../../implementation/current-status.md).
