...
>
> Сохранено как исторический план разработки. Не управляет текущим scope; используйте [product spec](../../product/NURA_1_0_1_5_PRODUCT_SPEC.md) и [current status](../../implementation/current-status.md).
...
- 💎 Полный разбор по подписке (buy_subscription)
- 🏠 В меню (main_menu)
