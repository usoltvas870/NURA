...
>
> Сохранено как история прежнего agent workflow. Не использовать для текущих задач; актуальная навигация находится в [docs router](../../README.md) и root `AGENTS.md`.
