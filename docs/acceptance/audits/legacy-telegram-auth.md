...
**STATUS: CURRENT DATED SECURITY EVIDENCE FOR A RETIRED FLOW — NON-NORMATIVE**

Документ подтверждает retirement boundary на своём baseline, но не является текущим product contract. См. [current status](../../implementation/current-status.md).
