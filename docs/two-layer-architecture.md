...
> **STATUS: MIXED — IMPLEMENTED CONCEPT + STALE FUTURE PATHS**
>
> До архитектурной консолидации Stage 2B сверяйте пути и contracts с кодом; target scope задаёт [canonical spec](product/NURA_1_0_1_5_PRODUCT_SPEC.md).
