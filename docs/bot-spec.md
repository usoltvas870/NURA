...
[Мини-разбор совместимости (2-3 бесплатных блока)]
    ↓
[CTA: Полный разбор совместимости — в составе полной матрицы 690 ₽ или подписки 390 ₽/мес]
```
...
Полный разбор — в составе полной матрицы 690 ₽ или подписки 390 ₽/мес
```
...
```
┌─────────────────────────────────────────────┐
│ ✨ Полная матрица 690 ₽ — полный разбор      │
├─────────────────────────────────────────────┤
...
```
[Пользователь нажимает ✨ Полный разбор за 690 ₽]
    ↓
...
```
┌─────────────────────────────┐
│ 💳 Оплатить 690 ₽           │  ← InlineKeyboardButton с URL
├─────────────────────────────┤
│ 🏠 В меню                   │
└─────────────────────────────┘
```
...
\* Отчёты для других людей приобретаются отдельно — 690 ₽ за каждый.
