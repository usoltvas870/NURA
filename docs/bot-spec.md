...
[Мини-разбор совместимости (Твой портрет + Портрет партнёра + Эмоциональная совместимость)]
    ↓
[CTA: Полный разбор совместимости — 890 ₽ разово]
```
...
> **Матрица и Таро независимы.** Покупка матрицы (890 ₽) не открывает таро-расклады. Таро-подписка работает без покупки матрицы.
