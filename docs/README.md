...
| `report-upgrade-sessions.md` | Детальный план апгрейда: 16 шагов, ~81ч | 📝 План |
| `report-upgrade-plan.md` | Старый 4-фазный план (~11ч) | ⚠️ Устарел — заменён выше |

### Таро

| Файл | Что описывает | Статус |
|------|--------------|--------|
| `tarot-integration-plan.md` | Интеграция таро на 3 поверхности: лендинг, бот, отчёт (~40ч) | 📝 План |
