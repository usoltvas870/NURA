...
- ❌ Страница отчёта — план апгрейда готов (16 шагов, 81ч), не начат
- 🟡 Таро-ритуалы — план готов (40ч), начата навигация: меню (has_tarot), обработчик buy_tarot_subscription, профиль таро-подписчика
- ❌ Навигация по отчёту — отсутствует (sidebar, TOC, якоря)
...
- 🔴 Страница отчёта требует полного апгрейда (16 шагов, 81ч) — без этого цена 890₽ не обоснована
